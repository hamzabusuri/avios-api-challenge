...
public class ParentalController {
    ...
    public ParentalControlRating checkParentalControlLevel(@PathVariable String movieId,
        ...
        boolean watch = parentalControlService.checkParentalControlLevel(movieId,pclPreference);
        return ParentalControlRating.builder().movieId(movieId).canWatch(watch).build();
    }
